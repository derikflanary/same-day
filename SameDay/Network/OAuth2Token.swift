...
struct OAuth2Token: Codable {
    ...
    private static let employeeIdKey = "employeeid"
    private static let refreshTokenKey = "refresh_token"

    init(accessToken: String, expiresAt: Date = Date.distantPast, userId: Int, refreshToken: String? = nil) {
    ...
    init(object: MarshaledObject) throws {
        ...
        self.userId = try object.value(for: OAuth2Token.employeeIdKey)
    }
    ...
    init?() throws {
        ...
        self.userId = try dictionary.value(for: OAuth2Token.employeeIdKey)
    }
    ...
    func lock() throws {
        let tokenValues: NSDictionary = [
            ...
            OAuth2Token.employeeIdKey: userId as AnyObject
        ]
