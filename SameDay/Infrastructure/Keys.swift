...
struct Keys {
    ...
    static let zipcodes = "zip_codes"

    static let invoiceId = "invoice_id"
    static let date = "appointment_date"
    ...
    static let addedByEmployeeId = "added_by_employee_id"
    static let dateAdded = "date_added"
    static let lastModifiedById = "last_modified_by_employee_id"
    static let modifiedDate = "last_modified_date"
    static let invoice = "invoice"

    static let accountId = "account_id"
    static let leadEmployeeId = "lead_employee_id"
    static let claimId = "claim_id"
    static let saleDate = "sale_date"
    static let installDate = "install_date"
    static let invoiceType = "invoice_type"
    static let status = "status"
    static let satelliteProvider = "satellite_provider"
    static let numberTvs = "number_tvs"
    static let promotionId = "promotion_id"
    static let kitId = "kit_id"
    static let receivers = "receivers"
    static let upgradeOptions = "upgrade_options"
    static let basePackageId = "base_package_id"
    static let programmingQuote = "programming_quote"
